...
import dabbaPayWomanImage from 'figma:asset/e73a6ac8067bab17eeaa5405833df34d81eb2b80.png';
import { 
  ArrowRight, 
  Shield, 
  CreditCard, 
...
export function DabbaPayPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-6 md:space-y-8 relative order-1 lg:order-1">
              ...
              <div className="space-y-4 sm:space-y-5 md:space-y-7 relative z-10">
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mt-3 sm:mt-4 max-w-4xl mx-auto lg:mx-0">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute -inset-4 bg-gradient-to-r from-orange-400/20 via-[#1E4A72]/20 to-[#22C55E]/20 rounded-3xl blur-2xl"
                      animate={{
                        scale: [1, 1.05, 1],
                        opacity: [0.3, 0.5, 0.3],
                      }}
                    ...
                    {/* Main image with subtle frame effect */}
                    <motion.div
                      className="relative bg-white rounded-2xl p-2 shadow-2xl border border-gray-100"
                      animate={{
                        boxShadow: [
                          "0 20px 60px rgba(0, 0, 0, 0.1)",
                          "0 25px 80px rgba(30, 74, 114, 0.15)",
                          "0 20px 60px rgba(0, 0, 0, 0.1)"
                        ]
                      }}
                      transition={{
                    ...
                    >
                      <ImageWithFallback
                        ...
                        alt="Happy customer using DABBA PAY app for micro loan repayments"
                        className="w-full h-auto rounded-xl object-cover"
                      />
                      
                      {/* Overlay success indicators */}
                      <motion.div
                        className="absolute top-4 right-4 bg-[#22C55E] text-white p-2 rounded-full shadow-lg"
                      ...
                      <motion.div
                        className="absolute -top-3 -left-3 bg-orange-500 text-white p-2 rounded-full shadow-lg"
                        animate={{
                          rotate: [0, 360],
                          scale: [1, 1.1, 1],
                        }}
                      ...
                      <motion.div
                        className="absolute -bottom-3 -right-3 bg-[#1E4A72] text-white p-2 rounded-full shadow-lg"
                        animate={{
                          rotate: [360, 0],
                          scale: [1, 1.1, 1],
                        }}
                ...
                <motion.div
                  className="absolute top-1/4 -left-8 w-2 h-2 bg-orange-400 rounded-full"
                  animate={{
                    y: [0, -20, 0],
                    opacity: [0, 1, 0],
                    scale: [0, 1, 0]
                ...
                <motion.div
                  className="absolute top-1/3 -right-6 w-1.5 h-1.5 bg-[#22C55E] rounded-full"
                  animate={{
                    y: [0, -15, 0],
                    opacity: [0, 1, 0],
                    scale: [0, 1, 0]
                ...
                <motion.div
                  className="absolute bottom-1/4 -left-4 w-1 h-1 bg-[#1E4A72] rounded-full"
                  animate={{
                    y: [0, -10, 0],
                    opacity: [0, 1, 0],
                    scale: [0, 1, 0]
              ...
              >
                ...
                >
                  <h3 className="text-lg font-bold text-gray-900">
                    <span className="text-[#22C55E]">✓</span> Financial Freedom Achieved!
                  </h3>
                </motion.div>
                <p className="text-sm text-gray-600 mb-4">
                  Join thousands who transformed their loan stress into manageable micro-repayments
                </p>
                ...
                >
                  ...
                  >
                    <motion.div
                      ...
                      transition={{ duration: 4, repeat: Infinity, ease: "linear" }}
                    >
                      <Headphones className="size-4 text-orange-600" />
                    </motion.div>
                    <span className="text-sm font-bold">Need Help? We're Here!</span>
                  </motion.div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <motion.div
                      ...
                      whileTap={{ scale: 0.98 }}
                      onClick={() => window.open('tel:+914842969999', '_blank')}
                      initial={{ opacity: 0, x: -10 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ duration: 0.6, delay: 1.5 }}
                    >
                      <Card className="p-2.5 bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200/50 hover:border-orange-300 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                        <motion.div
                          className="absolute top-0 right-0 w-8 h-8 bg-orange-200/30 rounded-full -mr-4 -mt-4"
                          animate={{ rotate: 360 }}
                          transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
                        />
                        <div className="flex flex-col items-center gap-1.5 relative z-10">
                          <motion.div
                            className="w-7 h-7 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform"
                            animate={{ 
                              boxShadow: [
                          ...
                          <div className="text-center">
                            <div className="text-xs font-bold text-gray-900 leading-tight">24/7 Call</div>
                            <div className="text-xs text-orange-600 font-medium">Instant Help</div>
                          </div>
                        </div>
                      </Card>
                    </motion.div>
                    ...
                    <motion.div
                      ...
                      whileHover={{ scale: 1.05, y: -2 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={() => window.open('https://wa.me/919048399999', '_blank')}
                      initial={{ opacity: 0, x: 10 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ duration: 0.6, delay: 1.6 }}
                    >
                      <Card className="p-2.5 bg-gradient-to-br from-green-50 to-green-100 border border-green-200/50 hover:border-green-300 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                        <motion.div
                          className="absolute top-0 right-0 w-8 h-8 bg-green-200/30 rounded-full -mr-4 -mt-4"
                          animate={{ rotate: -360 }}
                          transition={{ duration: 10, repeat: Infinity, ease: "linear" }}
                        />
                        <div className="flex flex-col items-center gap-1.5 relative z-10">
                          <motion.div
                            className="w-7 h-7 bg-gradient-to-br from-[#22C55E] to-green-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform"
                            animate={{ 
                              boxShadow: [
                          ...
                          <div className="text-center">
                            <div className="text-xs font-bold text-gray-900 leading-tight">WhatsApp</div>
                            <div className="text-xs text-green-600 font-medium">Quick Chat</div>
                          </div>
                        </div>
                      </Card>
                    </motion.div>
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => window.open('mailto:loans@dubbapay.com', '_blank')}
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: 1.7 }}
                  >
                    <Card className="p-2.5 bg-gradient-to-r from-blue-50 to-[#1E4A72]/5 border border-blue-200/50 hover:border-blue-300 hover:shadow-md transition-all duration-300 relative overflow-hidden">
                      <motion.div
                        className="absolute top-0 right-0 w-10 h-10 bg-blue-200/20 rounded-full -mr-5 -mt-5"
                        animate={{ rotate: 360 }}
                        transition={{ duration: 12, repeat: Infinity, ease: "linear" }}
                      />
                      <div className="flex items-center justify-center gap-2 relative z-10">
                        <motion.div
                          className="w-6 h-6 bg-gradient-to-br from-[#1E4A72] to-blue-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform"
                          animate={{ 
                            boxShadow: [
                              "0 2px 8px rgba(30, 74, 114, 0.3)",
                              "0 4px 12px rgba(30, 74, 114, 0.4)",
                              "0 2px 8px rgba(30, 74, 114, 0.3)"
                            ]
                          }}
                        ...
                        <div className="text-center">
                          <div className="text-xs font-bold text-gray-900">loans@dabbapay.com</div>
                          <div className="text-xs text-[#1E4A72] font-medium">Email Support (4hrs response)</div>
                        </div>
                      </div>
                    </Card>
                  </motion.div>
                  ...
                  {/* Trust Badge */}
                  <motion.div
                    className="flex items-center justify-center gap-2 mt-3 px-3 py-1.5 bg-gradient-to-r from-gray-50 to-orange-50/50 rounded-full border border-gray-200/50"
                  ...
                  >
                    ...
                    >
                      <Award className="size-3 text-[#22C55E]" />
                    </motion.div>
                    <span className="text-xs text-gray-700 font-medium">
                      Trusted by <span className="font-bold text-orange-600">25K+</span> customers
                    </span>
                    <motion.div
      ...
      {/* NPA Repayment Section - Bank Selection */}
      <NPARepaymentSection />

...
import contactCardsImage from 'figma:asset/413b1df61eb0b76fec62af32d1475ef77a137ec4.png';
import { 
  ArrowRight, 
  Shield, 
  CreditCard, 
...
export function DabbaPayPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-green-50 py-8 sm:py-12 md:py-16 lg:py-20 relative overflow-hidden min-h-screen flex items-center">
        <div className="container mx-auto px-3 xs:px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-16 items-start max-w-7xl mx-auto">
            ...
            {/* Visual Elements - Happy Customer with DABBA PAY App + Contact Cards */}
            <div className="lg:col-span-5 relative order-2 lg:order-2 flex flex-col items-center justify-start py-8 space-y-6">
              ...
              >
                ...
                >
                  <img
                    ...
                    alt="Happy Indian woman using DUBBAPAY app for flexible loan repayment"
                    className="w-full h-auto max-w-md lg:max-w-lg rounded-3xl shadow-2xl"
                  />
                </motion.div>

                {/* Background glow effect */}
                <motion.div
                  className="absolute inset-0 -z-10 bg-gradient-to-br from-orange-400/20 to-blue-400/20 rounded-full blur-3xl"
                  animate={{
                    opacity: [0.3, 0.7, 0.3],
                    scale: [1, 1.1, 1],
                  }}
                ...
                <motion.div
                  className="absolute top-8 right-8 bg-green-100 border-2 border-green-300 rounded-lg px-3 py-2 shadow-lg"
                  animate={{
                    y: [0, -8, 0],
                    rotate: [0, 5, 0],
                  }}
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-green-800">₹100 Paid</span>
                  </div>
                </motion.div>

                <motion.div
                  className="absolute bottom-8 left-8 bg-blue-100 border-2 border-blue-300 rounded-lg px-3 py-2 shadow-lg"
                  animate={{
                    y: [0, -6, 0],
                    rotate: [0, -3, 0],
                  }}
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-blue-800">Credit +10</span>
                  </div>
                </motion.div>
              </motion.div>

              {/* Contact Information Cards - Right Side Below Image */}
              <motion.div 
              ...
              >
                <img
                  src={contactCardsImage}
                  alt="Contact information cards for DUBBAPAY support"
      ...
      <section id="npa-calculator">
        <NPACalculator />
      </section>

      {/* NPA Repayment Features Section */}
      <NPARepaymentSection />
    </div>
  );
}